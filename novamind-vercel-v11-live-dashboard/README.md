...
- `POST /api/nova/chat` — powers the NovaMind AI chat. It gives planning guidance but never changes user data.
...
5. Optionally add `DEEPSEEK_MODEL` (the default is `deepseek-v4-flash`).
6. Deploy.
